...
map("n", "<leader>n", "<cmd>enew<cr>", { silent = true, desc = "New File"})
map("n", "<C-n>", "<cmd>enew<cr>", { silent = true, desc = "New File"})
map("n", "<C-W>", "<cmd>w!<cr>", { silent = true, desc = "Force write"})
map("n", "<C-q>", "<cmd>qa!<cr>", { silent = true, desc = "Force quit all"})
